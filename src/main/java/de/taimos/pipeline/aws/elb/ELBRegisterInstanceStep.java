...
public class ELBRegisterInstanceStep extends Step {
	private String targetGroupARN;
	private String instanceID;
	private int port;

	@DataBoundConstructor
	public ELBRegisterInstanceStep(String targetGroupARN, String instanceID, int port) {
	...
	public StepExecution start(StepContext context) throws Exception {
		return new ELBRegisterInstanceStep.Execution(this, context);
	}
	...
	public static class Execution extends SynchronousNonBlockingStepExecution<String> {
		private final transient ELBRegisterInstanceStep step;

		public Execution(ELBRegisterInstanceStep step, StepContext context) {
			super(context);
			this.step = step;
		}
